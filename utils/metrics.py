...
def Evaluation(y_predicted, y_true):
    ...
    micro_prec = precision_score(
        y_true, y_predicted, average='micro', zero_division=0)
    macro_prec = precision_score(
        y_true, y_predicted, average='macro', zero_division=0)
    weight_prec = precision_score(
    ...
    macro_rec = recall_score(
        y_true, y_predicted, average='macro', zero_division=0)
    weight_rec = recall_score(
        y_true, y_predicted, average='weighted', zero_division=0)

    macro_f1 = f1_score(y_true, y_predicted, average="macro", zero_division=0)
    micro_f1 = f1_score(y_true, y_predicted, average="micro", zero_division=0)
    weight_f1 = f1_score(y_true, y_predicted,
                         average="weighted", zero_division=0)

    subset_acc = accuracy_score(y_true, y_predicted)

    iou_acc = jaccard_score(y_true, y_predicted,
